...
class ClusterClient(NamespacedClient):
    ...
    @query_params("local", "main_timeout")
    ...
    @query_params(
        "dry_run", "explain", "main_timeout", "metric", "retry_failed", "timeout"
    )
    def reroute(self, body=None, params=None):
        ...
        :arg metric: Limit the information returned to the specified metrics.
            ...
            'metadata', 'nodes', 'routing_table', 'main_node', 'version'
    ...
    @query_params("flat_settings", "include_defaults", "main_timeout", "timeout")
    ...
    @query_params("flat_settings", "main_timeout", "timeout")
